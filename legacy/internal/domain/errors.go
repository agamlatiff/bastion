...
var (
	...
	ErrInvalidTwoFactorCode     = errors.New("invalid 6-digit two-factor authentication code")
	ErrInvalidTempToken         = errors.New("invalid or expired 2fa temporary token")
